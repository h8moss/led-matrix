/*#include "common/canvas/text_drawer.hpp"
#include "common/canvas/draw_line.hpp"
...
int TextDrawer::drawAUpper(int x, int y, Color c) const {
  drawLine(canvas, x, y + 2, 5, c, false);
  drawLine(canvas, x + 4, y + 2, 5, c, false);

  drawLine(canvas, x + 1, y + 4, 3, c);

  c.setCanvasPixel(x + 1, y + 1, canvas);
  c.setCanvasPixel(x + 2, y, canvas);
  c.setCanvasPixel(x + 3, y + 1, canvas);
...
int TextDrawer::drawBUpper(int x, int y, Color c) const {
  drawLine(canvas, x, y, 7, c, false);
  drawLine(canvas, x + 4, y + 1, 2, c);
  drawLine(canvas, x + 4, y + 4, 2, c);
...
int TextDrawer::drawDUpper(int x, int y, Color c) const {
  ...
  drawLine(canvas, x + 1, y, 2, c);
  drawLine(canvas, x + 1, y + 6, 2, c);
  drawLine(canvas, x + 4, y + 2, 3, c, false);
...
int TextDrawer::drawJUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawKUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawLUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawMUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawNUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawOUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawPUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawQUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawRUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawSUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawTUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawUUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawVUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawWUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawXUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawYUpper(int x, int y, Color c) const { return 0; }

int TextDrawer::drawZUpper(int x, int y, Color c) const { return 0; }
