commonObjects = bin/common/util/array_to_vector.o bin/common/util/split_string.o bin/common/models/color.o bin/common/canvas/drawLine.o bin/common/canvas/textDrawer.o bin/common/util/padZeros.o
